...
-(void)moveCellContent{
    labelXPosition = self.textLabel.frame.origin.x;
...
-(void)moveToNormal{
    ...
    self.textLabel.frame = CGRectMake(labelXPosition, self.textLabel.frame.origin.y, self.textLabel.frame.size.width, self.textLabel.frame.size.height);
}
